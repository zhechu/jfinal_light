...
<body>
	...
	<form id="loginForm" class="form-signin" action="${ctx}/doLogin" method="post">
		...
		<div class="validateCode">
			...
			<sys:validateCode name="validateCode" inputCssStyle="margin-bottom:0;" imageCssStyle="cursor: pointer;"/>
		</div>
		<input class="btn btn-large btn-primary" type="submit" value="登 录"/>&nbsp;&nbsp;
		<label for="rememberMe" title="下次不需要再登录"><input type="checkbox" value="true" id="rememberMe" name="rememberMe" ${rememberMe ? 'checked' : ''}/> 记住我（公共场所慎用）</label>
